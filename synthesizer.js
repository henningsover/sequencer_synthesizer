window.onload = () => {
  ...
  console.log(parseFloat(bpmInMs));
  ...
  function loadAndSetPresets() {
    Object.keys(presetPatterns).forEach(function (pattern) {
      ...
      Object.keys(currentPattern).forEach(function (step) {
        // console.log(currentPattern[step].toneName)
  ...
  function drawSequencer() {
    ...
    // // sequencer.removeChild(oldSequencer)
    sequencer.innerHTML = "";
  ...
  // headers.forEach(header => header.addEventListener('click', displayMe(this)));

  // function displayMe(header) {
  //   console.log(header)
  // }
  // console.log(headers);
